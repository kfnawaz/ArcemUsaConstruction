...
import { ArrowRight, Building2, Truck, Users, CheckCircle2, Badge, Clock, TrendingUp, Handshake } from 'lucide-react';
      ...
      <div className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <motion.div 
            ...
            variants={staggerContainer}
          >
            <motion.div variants={benefitVariants} className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mb-4">
                <Handshake className="text-[#1E90DB] h-6 w-6" />
              </div>
              <h3 className="text-xl font-bold mb-2">Long-term Partnerships</h3>
              <p className="text-gray-600">We focus on building lasting relationships rather than one-time contracts</p>
            </motion.div>
            ...
            <motion.div variants={benefitVariants} className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Access to high-profile projects and continuous professional development</p>
            </motion.div>
            ...
            <motion.div variants={benefitVariants} className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Reliable payment schedules for subcontractors and vendors</p>
            </motion.div>
            ...
            <motion.div variants={benefitVariants} className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Association with our reputable brand and award-winning projects</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="space-y-3 mb-8 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="text-[#1E90DB] h-5 w-5 flex-shrink-0" />
                    <span className="text-gray-700">Long-term supply agreements</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="text-[#1E90DB] h-5 w-5 flex-shrink-0" />
            ...
            <div className="bg-white p-8 md:p-10 rounded-lg shadow-lg relative">
              ...
              <div className="flex items-center justify-center">
                <div>
                  ...
                  <p className="text-gray-500">Elite Electrical Services, Subcontractor</p>
                </div>
              </div>
            </div>
          </motion.div>
